...
import laowai_panda.yandex_metrika as yandex_metrika
...
class MyDefaultIndexDashboard(DefaultIndexDashboard):
    ...
    def init_with_context(self, context):
        ...
        super(DefaultIndexDashboard, self).init_with_context(context)
